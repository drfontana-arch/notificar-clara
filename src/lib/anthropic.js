...
import { PROMPT_BASE, PROMPTS_POR_TIPO } from './prompts/index.js'

const client = new Anthropic({ apiKey: process.env.ANTHROPIC_API_KEY })

export async function procesarNotificacion(textoOriginal, tipoActo) {
...
en lenguaje claro y empático. Nunca das consejos legales. Si la pregunta está fuera de lo que podés responder
con certeza, decilo honestamente e indicá que la persona consulte con el órgano emisor o su abogado/a.
